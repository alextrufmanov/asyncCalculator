...
func (s *Storage) newExpression(expression string) *models.Expression {
...
func (s *Storage) AppendExpression(expressionStr string) (int, bool) {
	...
	expression := s.newExpression(expressionStr)
...
func (s *Storage) GetExpressionByID(id int) (models.Expression, bool) {
...
func (s *Storage) SetTaskResult(id int, result float64, success bool) bool {
